...
## Resources
Read or watch:
- [NoSQL Databases Explained](https://www.mongodb.com/resources/basics/databases/nosql-explained)
- [What is NoSQL?](https://www.mongodb.com/resources/basics/databases/nosql-explained)
- [MongoDB with Python Crash Course - Tutorial for Beginners](https://realpython.com/introduction-to-mongodb-and-python/)
- [MongoDB Tutorial 2: Insert, Update, Remove, Query](https://www.geeksforgeeks.org/mongodb-tutorial/)
- [Aggregation](https://www.mongodb.com/docs/manual/aggregation/)
- [Introduction to MongoDB and Python](https://realpython.com/introduction-to-mongodb-and-python/)
- [mongo Shell Methods](https://www.mongodb.com/docs/manual/reference/method/)
- [The mongo Shell](https://www.mongodb.com/docs/manual/reference/mongo-shell/)
...
You can use this dump as data sample: [dump.zip](https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-webstack/411/dump.zip)
