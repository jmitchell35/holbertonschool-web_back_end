...
This module provides utilities for generating asynchronous sequences of random values.
"""
...
async def async_generator() -> Generator[float, None, None]: # type: ignore
    ...
    Returns:
        Generator[float, None, None]: An asynchronous generator yielding random floats.
